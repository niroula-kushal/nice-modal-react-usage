...
export default function App() {
  ...
  useEffect(() => {
    if (searchParams.get("modal") === "side") {
      NiceModal.show(SideModal, {
        name: searchParams.get("name") || "Nate",
        childOpen: searchParams.get("child") === "1",
        onCloseAll: closeAllModalsInUrl,
        onOpenChild: openChildInUrl,
      })
    } else {
      NiceModal.hide(SideModal)
    }
  }, [searchParams])
        ...
        <main className="p-6 md:p-8">
          <div className="mb-8 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" onClick={openSideWithUrl}>
                Open Side Modal
              </Button>
